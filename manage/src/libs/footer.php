            ...
            <form action="#" method="post" class="needs-validation" novalidate>
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="example-text-input" placeholder="حط اسم الفعالية هنا" required>
                    </div>
                        ...
                        <div class="col-lg-8">
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-flat">
                                    <input type="text" class="form-control ps-0" autocomplete="off" style="direction: ltr;" placeholder="https://chat.whatsapp.com/XXXXXXX">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div>
                                ...
                                <textarea class="form-control" rows="3" placeholder="أكتب كل شيء يخص الفعالية بالتفصيل الممل D:"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<!-- Libs JS -->
<script src="./src/inc/dist/libs/apexcharts/dist/apexcharts.min.js"></script>
<script src="./src/inc/dist/libs/jsvectormap/dist/js/jsvectormap.min.js"></script>
<script src="./src/inc/dist/libs/jsvectormap/dist/maps/world.js"></script>
<!-- Tabler Core -->
<script src="./src/inc/dist/js/tabler.min.js"></script>
<script src="./src/inc/dist/js/demo.min.js"></script>
<script>
    // @formatter:off
